...
- [ ] Механизм модерации магазина:
  ...
  после подтверждения user может добавлять продукты от своей организации, которые так же проходят модерацию у
  администратора. Администратор может заблокировать организацию по каким либо причинам, после разблокировки
  все настройки организации снова становятся актуальными. 
  Администратор так же может заблокировать пользователя (функционал в разработке..). 
